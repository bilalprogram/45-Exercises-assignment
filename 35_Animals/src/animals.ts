//Animals: Think of at least three different animals that have a common characteristics. store the name of these animals in a list, and then use a for loop to print out the name of each animal.
